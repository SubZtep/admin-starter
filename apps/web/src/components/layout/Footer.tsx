export function Footer() {
  ...
  return (
    <footer className="mt-10 border-t border-border/40 px-4 pb-14 pt-10 text-muted">
      <div className="container flex flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left">
        ...
        <p className="text-xs font-bold uppercase tracking-wider text-muted">Built with TanStack Start</p>
      </div>
