...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-(--line) bg-(--header-bg) px-4 backdrop-blur-lg">
      <nav className="page-wrap flex flex-wrap-reverse items-center gap-x-3 gap-y-2 py-3 sm:py-4 hover:[&_.lucide-paw-print]:animate-pulse">
        {isLoading ? (
          <Loader slim />
        ) : (
          <>
            {user ? (
              ...
              <PawPrint className="hover:cursor-none text-pink-800" />
            )}
