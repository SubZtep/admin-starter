  ...
  return (
    <AlertDialog.Root>
      ...
      <AlertDialog.Portal>
        ...
        <AlertDialog.Popup className="fixed top-1/2 left-1/2 -mt-8 w-96 max-w-[calc(100vw-3rem)] -translate-x-1/2 -translate-y-1/2 rounded-lg bg-surface-container border border-outline-variant/30 p-6 text-on-surface outline-none transition-all duration-150 data-ending-style:scale-90 data-ending-style:opacity-0 data-starting-style:scale-90 data-starting-style:opacity-0 ">
          <AlertDialog.Title className="-mt-1.5 mb-1 text-lg font-bold font-headline">{title}</AlertDialog.Title>
          <AlertDialog.Description className="mb-6 text-base text-on-surface-variant">
            {description}
