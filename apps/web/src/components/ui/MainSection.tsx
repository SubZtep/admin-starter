...
export function MainSection({ className, children }: { className?: string; children: React.ReactNode }) {
  return <section className={cn(ISLAND_SHELL_CLASSES, "rounded-2xl p-6 sm:p-8 mx-auto", className)}>{children}</section>
}
